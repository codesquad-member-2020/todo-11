...
INSERT INTO note(column_name, content, user_id, deleted)
VALUES ('해야할일', 'dan 이 해야할 일 1', 'dan', TRUE);
INSERT INTO note(column_name, content, user_id, deleted)
VALUES ('해야할일', 'dan 이 해야할 일 2', 'dan', TRUE);

INSERT INTO note(column_name, content, user_id, deleted)
VALUES ('하는중', 'dan 이 하는중 1', 'dan', TRUE);
INSERT INTO note(column_name, content, user_id, deleted)
VALUES ('하는중', 'dan 이 하는중 2', 'dan', TRUE);
INSERT INTO note(column_name, content, user_id, deleted)
VALUES ('하는중', 'dan 이 하는중 3', 'dan', TRUE);

INSERT INTO note(column_name, content, user_id, deleted)
VALUES ('다했어', 'sally 가 다했어 1', 'sally', TRUE);
INSERT INTO note(column_name, content, user_id, deleted)
VALUES ('다했어', 'sally 가 다했어 2', 'sally', TRUE);
INSERT INTO note(column_name, content, user_id, deleted)
VALUES ('다했어', 'sally 가 다했어 3', 'sally', TRUE);
