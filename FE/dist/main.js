...
/***/ "./src/eventController/deleteEvent.js":
/*!********************************************!*\
  !*** ./src/eventController/deleteEvent.js ***!
  \********************************************/
/*! exports provided: deleteEventHandle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"deleteEventHandle\", function() { return deleteEventHandle; });\n/* harmony import */ var _constants_url_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constants/url.js */ \"./src/constants/url.js\");\n/* harmony import */ var _util_dom_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/dom.js */ \"./src/util/dom.js\");\n\n\n\nconst deleteEventHandle = () => {\n    Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_1__[\"getElements\"])(`.note-wrap`).forEach(noteWrap => {\n        noteWrap.addEventListener('click', (e) => {\n            if (e.target.className !== 'note-removeBtn') return;\n            const noteIndex = e.target.closest('.note').id;\n            // removeNote(noteIndex);\n            console.log(noteIndex);\n        });\n\n    })\n}\n\nconst removeNote = (noteIndex) => {\n    fetchJSON_DELETE(_constants_url_js__WEBPACK_IMPORTED_MODULE_0__[\"URL\"].DEV.DELETE_NOTE_API + noteIndex);\n}\n\nconst fetchJSON_DELETE = (url) => {\n    return fetch(url, {\n        method: 'DELETE',\n        headers: { \"Accept\": \"*/*\" },\n    });\n}\n\n//# sourceURL=webpack:///./src/eventController/deleteEvent.js?");

/***/ }),

/***/ "./src/eventController/inputBoxEvent.js":
/*!**********************************************!*\
  !*** ./src/eventController/inputBoxEvent.js ***!
  \**********************************************/
/*! exports provided: inputBoxEventHandle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"inputBoxEventHandle\", function() { return inputBoxEventHandle; });\n/* harmony import */ var _util_dom_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/dom.js */ \"./src/util/dom.js\");\n\n\nconst inputBoxEventHandle = (category) => {\n    Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"getElement\"])(`.category.${category.name} .category-menu_addBtn`).addEventListener('click', () => {\n        const addNote = Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"getElement\"])(`.category.${category.name} .add-note`);\n        const addNoteDisplay = addNote.style.display;\n        switch (addNoteDisplay) {\n            case 'block': Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"hide\"])(addNote);\n                break;\n            case \"\": Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"show\"])(addNote);\n                break;\n            case 'none': Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"show\"])(addNote);\n                break;\n        }\n    })\n\n    let inputBox = Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"getElement\"])(`.category.${category.name} .add-note_input`);\n    inputBox.addEventListener('keyup', () => {\n        const addBtn = Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"getElement\"])(`.category.${category.name} .add-note_addBtn`);\n        if (inputBox.value != \"\") Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"removeClass\"])(addBtn, 'disable');\n        else Object(_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"addClass\"])(addBtn, 'disable');\n    })\n\n\n    // getElement(`.category.${category.name} > .add-note_addBtn`).addEventListener('click', () => {\n\n    // })\n\n}\n\n\n//# sourceURL=webpack:///./src/eventController/inputBoxEvent.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"drawCategorySection\", function() { return drawCategorySection; });\n/* harmony import */ var _src_util_dom_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/util/dom.js */ \"./src/util/dom.js\");\n/* harmony import */ var _templates_note_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../templates/note.js */ \"./templates/note.js\");\n/* harmony import */ var _src_eventController_inputBoxEvent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../src/eventController/inputBoxEvent.js */ \"./src/eventController/inputBoxEvent.js\");\n/* harmony import */ var _src_eventController_deleteEvent_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src/eventController/deleteEvent.js */ \"./src/eventController/deleteEvent.js\");\n\n\n\n\n\n\nconst drawCategorySection = (category, noteState) => {\n    Object(_src_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"getElement\"])('.category-wrap').insertAdjacentHTML('beforeend', renderState(category, noteState));\n    Object(_src_eventController_inputBoxEvent_js__WEBPACK_IMPORTED_MODULE_2__[\"inputBoxEventHandle\"])(category);\n    Object(_src_eventController_deleteEvent_js__WEBPACK_IMPORTED_MODULE_3__[\"deleteEventHandle\"])(category);\n}\n\nconst renderState = (category, noteState) => {\n    let categoryHTML = `\n        <div class=\"category ${category.name}\">\n            <div class=\"category-menu\">\n                <div class=\"category-menu_left\">\n                    <span class=\"category-menu_count\">${noteState.contents.notes.length}</span>\n                    <span class=\"category-menu_title\">${category.name}</span>\n                </div>\n                <div class=\"category-menu_right\">\n                    <button class=\"category-menu_addBtn\">+</button>\n                    <button class=\"category-menu_menu\">&hellip;</button>\n                </div>\n            </div>\n            <div class=\"add-note\">\n                <input class=\"add-note_input\" type=\"text\" placeholder=\"Enter a note\">\n                <button class=\"add-note_addBtn disable\">Add</button>\n                <button class=\"add-note_cancleBtn\">Cancle</button>\n            </div>\n            <div class=\"note-wrap\">${Object(_templates_note_js__WEBPACK_IMPORTED_MODULE_1__[\"drawNoteSection\"])(noteState)}</div>\n        </div>\n    `\n\n    return categoryHTML; //+ '<button class=\"add-category\">+Add category</button>';\n}\n\n\n//# sourceURL=webpack:///./templates/category.js?");
...
/*!******************************!*\
  !*** ./templates/history.js ***!
  \******************************/
/*! exports provided: drawHistory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"drawHistory\", function() { return drawHistory; });\n/* harmony import */ var _src_util_dom_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/util/dom.js */ \"./src/util/dom.js\");\n/* harmony import */ var _src_util_time_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/util/time.js */ \"./src/util/time.js\");\n\n\n\nconst drawHistory = (historys) => {\n    Object(_src_util_dom_js__WEBPACK_IMPORTED_MODULE_0__[\"getElement\"])('.histoty-contents').innerHTML = renderState(historys);\n}\n\nconst renderState = (historys) => {\n    let historyHTML = ''\n    historys.contents.history.forEach(element => {\n        historyHTML += `\n            <li class=\"history-content\">@${element.user}\n            <br>\n            ${Object(_src_util_time_js__WEBPACK_IMPORTED_MODULE_1__[\"timeSince\"])(new Date(element.createdAt))}\n            </li>\n        `\n    });\n\n    return `\n        <li class=\"histoty-menu\">MENU</li>\n        <li class=\"histoty-menu\">Acitivity</li>\n        ${historyHTML}\n    `;\n\n}\n\n\n//# sourceURL=webpack:///./templates/history.js?");
